Hyrax.config do |config|
  # Injected via `rails g hyrax:work Dao`
  config.register_curation_concern :dao
  # Injected via `rails g hyrax:work Image`
  config.register_curation_concern :image
  # Injected via `rails g hyrax:work Av`
  config.register_curation_concern :av
  # Injected via `rails g hyrax:work Sip`
  config.register_curation_concern :sip
